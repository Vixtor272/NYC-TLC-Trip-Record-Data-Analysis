...
standardized_trips as (
    select
        *,
        ...
        -- Reglas de calidad de datos: revisión de inconsistencias 
        case 
        ...
        -- Validación de fechas: que la fecha de DO no sea menor que la de PU
        case 
            when PICKUP_DATETIME > DROPOFF_DATETIME then 1
            else 0
        end as HAS_INVALID_TIMING,
        
        -- Duración del viaje en minutos: calculamos duración en minutos
        datediff('minute', PICKUP_DATETIME, DROPOFF_DATETIME) as TRIP_DURATION_MINUTES,
        
        -- Validación de datos requeridos: location not null, si es null lo mandamos a 0
        case 
...
-- Enriquecer con Taxi Zones: añadimos las zonas correspondientes a pickup y dropoff
...
final as (
    select
        ...
        -- Fechas y tiempos estandarizados del viaje
        YEAR,
        MONTH,
